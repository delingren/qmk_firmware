...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT_68_ansi( \
        ...
        _______,    _______,_______,_______,RESET,  _______,_______,_______,_______,_______,_______,_______,_______,_______,      _______,KC_END, \
  ...
  [_LL] = LAYOUT_68_ansi( \
        ...
        _______,          _______,_______,_______,_______,_______,_______,_______,KC_VOLD,KC_VOLU,KC_MUTE,_______,                BL_INC,         \
        _______,  _______,  _______,                      _______,                      _______,  _______,  _______,      BL_TOGG,BL_DEC,BL_BRTG  \
    ),
};
