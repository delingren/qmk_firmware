...
[_BASE] = LAYOUT_all(
    ...
    KC_LCTL, LOWER,   KC_LALT, KC_LGUI,          LT_ENT, KC_MUTE, LT_SPC,           KC_RGUI, KC_RALT, RAISE,   KC_RCTL
),
...
[_LOWER] = LAYOUT_all(
    ...
    MO_NUM,  _______, _______, _______,          _______, _______, _______,          _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT_all(
    ...
    TG_NUM,  _______, _______, _______,          _______, _______, _______,          _______, _______, _______, _______
),
