...
[_BASE] = LAYOUT_unified_bs_rshift(
	...
	KC_LCTL, KC_LGUI,          KC_LALT,          LT_ENT,  LT_SPC,           KC_APP,                    KC_RALT, KC_RGUI, KC_RCTL),
...
[_LOWER] = LAYOUT_unified_bs_rshift(
	...
	KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,  KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______,          _______,
...
[_ADJUST] = LAYOUT_unified_bs_rshift(
  ...
  _______, _______, _______, _______, _______, _______, KC_DEL,  _______, _______, KC_VOLD, KC_VOLU, KC_MUTE,          _______,
  _______, _______, _______,          _______,          _______,          _______,                   _______, _______, _______)
};
// clang-format on
