...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_tkl_ansi(
        ...
        KC_NAVCAPS,    KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,
    ...
    [2] = LAYOUT_tkl_ansi(
        RESET,            KC_BRID, KC_BRIU, KC_NO,   KC_NO,   BL_DEC,  BL_INC, KC_MRWD, KC_MPLY, KC_MFFD, KC_MUTE,  KC_VOLD, KC_VOLU,       BL_TOGG, RGB_TOG, RGB_MOD,
        ...
        KC_CAPS,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,           KC_CAPS,               KC_PGUP,
