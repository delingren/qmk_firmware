...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_unicorne(
    ...
    KC_CAPS,  KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,   KC_PIPE,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_MINS,  KC_EQL,
    _______,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,   KC_BSLS,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  _______,  _______,
                        _______,  _______,   _______,  _______,            ADJUST,   KC_LBRC,  KC_RBRC,  KC_BSLS
  ),
  ...
  [_RAISE] = LAYOUT_unicorne(
    ...
    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,              KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
                        _______,  _______,  _______,   ADJUST,             _______,  KC_LCBR,  KC_RCBR,  KC_PIPE
  ),
